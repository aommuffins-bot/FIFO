"""
api_server.py -- A.O.M Cafe Jin-Xiao-Cun API v5
Update: inventory report new columns (batch cost/receive qty/issued qty/supplier),
transactions report shows OUT only, unit price labeled (g), channel supports custom text.
"""
...
@app.get("/")
async def root():
    return {"message": "A.O.M Cafe Jin-Xiao-Cun API v5.0.0", "status": "online", "total_sku": len(PRODUCTS_DB)}
